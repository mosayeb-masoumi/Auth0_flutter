...
/// source = https://auth0.com/blog/get-started-with-flutter-authentication/
/// read the source then implement codes
...
const String AUTH0_DOMAIN = 'dev-8g4dvfjf.us.auth0.com';
const String AUTH0_CLIENT_ID = 'TEhr8twvo7FZNNk2NefRrQsYpuWXrsxY';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<Map<String, dynamic>> getUserDetails(String accessToken) async {
    ...
    // final http.Response response = await http.get(url, headers: <String, String>{'Authorization': 'Bearer $accessToken'},);
    final response = await http.get(Uri.parse(url), headers: <String, String>{'Authorization': 'Bearer $accessToken'},);
